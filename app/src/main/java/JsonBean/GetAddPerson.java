...
public class GetAddPerson {
    ...
    @Generated(hash = 1521797958)
    public GetAddPerson(Long pid, String user_id, String name, String work_sn,
    ...
    public String toString() {
        return "GetAddPerson{" +
                ...
                ", idface_template='" + idface_template + '\'' +
                ", vlface_template='" + vlface_template + '\'' +
                '}';
    }
}
